...
{
    //<editor-fold>
    public final CobblestoneGeneratorTileEntity tileEntity;
    private final IWorldPosCallable canInteractWithCallable;

    public CobblestoneGeneratorContainer(final int windowId, final PlayerInventory playerInventory, final CobblestoneGeneratorTileEntity tileEntity) {
        super(ModContainerTypes.COBBLESTONE_GENERATOR.get(), windowId);
    ...
    public CobblestoneGeneratorContainer(final int windowId, final PlayerInventory playerInventory, final PacketBuffer data) {
        this(windowId, playerInventory, getTileEntity(playerInventory, data));
    }

    private static CobblestoneGeneratorTileEntity getTileEntity(final PlayerInventory playerInventory, final PacketBuffer data) {
        ...
        if (tileEntity instanceof CobblestoneGeneratorTileEntity) {
            return (CobblestoneGeneratorTileEntity) tileEntity;
        }
    ...
    public boolean stillValid(PlayerEntity player) {
        return stillValid(canInteractWithCallable,player, ModBlocks.COBBLESTONE_GENERATOR.get());
    }

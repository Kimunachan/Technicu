...
@OnlyIn(Dist.CLIENT)
public class BlockBreakerScreen extends ContainerScreen<BlockBreakerContainer>
{
    //<editor-fold>
    private static final ResourceLocation TEXTURE = new ResourceLocation(Technicu.MOD_ID,"textures/gui/block_breaker.png");
    private static final TranslationTextComponent TITLE = new TranslationTextComponent("container." + Technicu.MOD_ID + ".block_breaker");

    BlockBreakerContainer container;

    public BlockBreakerScreen(BlockBreakerContainer screenContainer, PlayerInventory playerInventory, ITextComponent title) {
    ...
    protected void renderBg(MatrixStack matrixStack, float partialTicks, int mouseX, int mouseY)
    {
        ...
        this.blit(matrixStack, getGuiLeft()+24, getGuiTop()+18+(50-pixel), 176, (50-pixel), 12, 50);
    }
    ...
    protected void renderTooltip(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        if(mouseX >= getGuiLeft()+24 && mouseX < getGuiLeft()+24+12){

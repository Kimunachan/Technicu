...
@OnlyIn(Dist.CLIENT)
public class BlockPlacerScreen extends ContainerScreen<BlockPlacerContainer>
{
    //<editor-fold>
    private static final ResourceLocation TEXTURE = new ResourceLocation(Technicu.MOD_ID,"textures/gui/block_placer.png");
    private static final TranslationTextComponent TITLE = new TranslationTextComponent("container." + Technicu.MOD_ID + ".block_placer");

    BlockPlacerContainer container;

    public BlockPlacerScreen(BlockPlacerContainer screenContainer, PlayerInventory playerInventory, ITextComponent title) {

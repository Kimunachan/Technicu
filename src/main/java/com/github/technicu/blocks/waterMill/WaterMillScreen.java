...
@OnlyIn(Dist.CLIENT)
public class WaterMillScreen extends ContainerScreen<WaterMillContainer>
{
    //<editor-fold>
    private static final ResourceLocation TEXTURE = new ResourceLocation(Technicu.MOD_ID,"textures/gui/water_mill.png");
    private static final TranslationTextComponent TITLE = new TranslationTextComponent("container." + Technicu.MOD_ID + ".water_mill");

    WaterMillContainer container;

    public WaterMillScreen(WaterMillContainer screenContainer, PlayerInventory playerInventory, ITextComponent title) {
    ...
    protected void renderBg(MatrixStack matrixStack, float partialTicks, int mouseX, int mouseY)
    {
        ...
        this.blit(matrixStack, getGuiLeft()+62, getGuiTop()+18+(50-pixel), 176, (50-pixel), 12, 50);
    }
    ...
    protected void renderTooltip(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        if(mouseX >= getGuiLeft()+62 && mouseX < getGuiLeft()+62+12){

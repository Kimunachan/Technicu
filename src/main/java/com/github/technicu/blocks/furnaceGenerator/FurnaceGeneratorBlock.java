...
public class FurnaceGeneratorBlock extends Block
{
    ...
    public ActionResultType use(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult rayTrace)
    {
        if (!world.isClientSide())
        {
            ...
            {
                NetworkHooks.openGui((ServerPlayerEntity) player, (FurnaceGeneratorTileEntity) tileEntity, pos);
    ...
    public void onRemove(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving)
    {
        if (!state.is(newState.getBlock()))
        {
            ...
            if (tileEntity instanceof FurnaceGeneratorTileEntity)
            {
                InventoryHelper.dropContents(world, pos, (FurnaceGeneratorTileEntity) tileEntity);

...
public class ModAdvancedAlloyingRecipe implements IChargingRecipe
{
    private final ResourceLocation id;
    private Ingredient input;
    private final ItemStack output;

    public ModAdvancedAlloyingRecipe(ResourceLocation id, Ingredient input, ItemStack output)
    {
        this.id = id;
        this.input = input;
        this.output = output;
    ...
    {
        return ModRecipes.ADVANCED_ALLOYING_SERIALIZER.get();
    }

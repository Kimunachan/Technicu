...
public class ModChargingRecipe implements IChargingRecipe
{
    private final ResourceLocation id;
    private Ingredient input;
    private final ItemStack output;

    public ModChargingRecipe(ResourceLocation id, Ingredient input, ItemStack output)
    {
        this.id = id;
        this.input = input;
        this.output = output;
    ...
    {
        return ModRecipes.CHARGING_SERIALIZER.get();
    }
